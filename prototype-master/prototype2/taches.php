...
<?php
    ...
    // $Gestion->setProjet($Gestion_data['project_id']);
    $Gestions = $gestionProjets->RechercherTous('tache');
...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-end">
            ...
            <a href="./UI/ajouter.php?ajouter=tache">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                <a  href="./UI/supprimer.php?TacheId=<?php echo $Gestion->getId() ?>">
                                ...
                                <a  href="./UI/editer.php?TacheId=<?php 
                                    echo $Gestion->getId() ?>">
